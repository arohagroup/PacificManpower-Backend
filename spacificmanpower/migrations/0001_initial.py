# Generated by Django 4.0.6 on 2023-04-01 04:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill_set_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='skill_set_id', to='spacificmanpower.skill_set')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='job_post',
            name='posted_by_id',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='posted_by_id', to='spacificmanpower.job_post_activity'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdDate', models.DateTimeField(auto_now_add=True)),
                ('modifiedDate', models.DateTimeField(auto_now=True)),
                ('company_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='company_id_company_image', to='spacificmanpower.company')),
            ],
        ),
    ]
