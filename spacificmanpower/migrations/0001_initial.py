# Generated by Django 4.0.6 on 2023-05-19 05:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscribed_email_id', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_job_apply_date', models.DateTimeField(auto_now=True, null=True)),
                ('createdDate', models.DateTimeField(auto_now_add=True)),
                ('modifiedDate', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdDate', models.DateTimeField(auto_now_add=True)),
                ('modifiedDate', models.DateTimeField(auto_now=True)),
                ('user_account_id', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_account_id_subscribe', to='spacificmanpower.user_account')),
            ],
        ),
        migrations.CreateModel(
            name='skill_set',
            fields=[
                ...
                ('createdDate', models.DateTimeField(auto_now_add=True)),
                ('modifiedDate', models.DateTimeField(auto_now=True)),
                ('user_account_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='user_account_id_skill_set', to='spacificmanpower.user_account')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdDate', models.DateTimeField(auto_now_add=True)),
                ('modifiedDate', models.DateTimeField(auto_now=True)),
                ('user_account_id', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_account_id_recservice', to='spacificmanpower.user_account')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdDate', models.DateTimeField(auto_now_add=True)),
                ('modifiedDate', models.DateTimeField(auto_now=True)),
                ('experience', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experince_type_job_post_activity', to='spacificmanpower.experince_type')),
                ...
                ('user_account_id', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_account_idssss', to='spacificmanpower.user_account')),
            ],
        ),
        migrations.AddField(
            model_name='job_post',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='user_account_id_job_post', to='spacificmanpower.user_account'),
        ),
        migrations.CreateModel(
            name='gallery',
            fields=[
        ...
        migrations.AddField(
            model_name='company',
            name='user_account_id',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_account_id_company', to='spacificmanpower.user_account'),
        ),
        migrations.AddField(
            model_name='business_stream',
            name='user_account_id',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='user_account_id_business_stream', to='spacificmanpower.user_account'),
        ),
    ]
